...
// #cgo CFLAGS: -mmacosx-version-min=10.12 -DMACOSX_DEPLOYMENT_TARGET=10.12
// #cgo LDFLAGS: ${SRCDIR}/libui_darwin_amd64.a -framework Foundation -framework AppKit -lpthread -mmacosx-version-min=10.12
