...
// SetColor sets the color the text
func (l *TextLayout) SetColor(startChar int, endChar int, r float64, g float64, b float64, a float64) {
	C.uiDrawTextLayoutSetColor(l.l, C.intmax_t(startChar), C.intmax_t(endChar), C.double(r), C.double(g), C.double(b), C.double(a))
}
